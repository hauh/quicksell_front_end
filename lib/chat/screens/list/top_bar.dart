  ...
  Widget build(BuildContext context) {
    return RichText(
      ...
      text: TextSpan(
        ...
        children: [
          TextSpan(
            text: "sell", style: TextStyle(color: Colors.black, fontSize: 30),
          ),
        ]
      ),
    );
          ...
          children: <Widget>[
            Expanded(
              child: IconButton(
                ...
                onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => BlackList()))
              )
            ),
            Expanded(flex: 6, child: Center(child: ChatListTopBarTitle()),),
            Expanded(
              child: IconButton(
